...
sequence every 2 seconds while RotMG is the active window. Press the
...
pressed, then the first key is released last. 
...
running. The activation hotkey and healing key are both editable.
